  ...
  return (
    <div className="p-8 bg-skooli-cream">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-emerald-green mb-4">Partner with Skooli for Business</h1>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-emerald-green mb-3">Why Partner with Us?</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-emerald-green mb-3">Get Started</h2>
